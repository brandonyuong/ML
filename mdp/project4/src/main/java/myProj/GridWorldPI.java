...
public class GridWorldPI extends MDPSolver implements PolicyIteration, QProvider {
    ...
    public GridWorldPI(SADomain domain, double gamma,
    ...
    public static void main(String [] args){
        ...
        GridWorldPI pi = new GridWorldPI(domain, 0.99, new SimpleHashableStateFactory(),
