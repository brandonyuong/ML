...
def analyze_nn():
    ...
    plt.xticks(xi, iter_list)
    plot_rand_opt(xi, rhc_avgs_arr[:, 2], plot_label="RHC", custom_color="#f92672")
    plot_rand_opt(xi, sa_avgs_arr[:, 2], plot_label="SA", custom_color="#007fff")
    plot_rand_opt(xi, ga_avgs_arr[:, 2], plot_label="GA", custom_color="#05acbf")
    plt.grid(axis='x')
    plt.legend(loc="best")
    plt.savefig(title + ".png")
