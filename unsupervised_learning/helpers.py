...
def export_xy_data(x_df, y_df, data_name='unnamed'):
    data_name_x = data_name + '_x.csv'
    data_name_y = data_name + '_x.csv'
    x_df.to_csv(data_name_x, index=False)
    y_df.to_csv(data_name_y, index=False, header=[y_df.name])
